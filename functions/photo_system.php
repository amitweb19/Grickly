<?php
include_once("../../function/check_login_status.php");
?><?php 
...
if (isset($_FILES["profilepic"]["name"]) && $_FILES["profilepic"]["tmp_name"] != ""){
	...
	$profilepic = $row[0];
	if($profilepic != ""){
		$picurl = "../../user/$log_username/$profilepic"; 
	...
	include_once("../../function/image_resize.php");
	...
	$query = mysqli_query($db_conx, $sql);
	mysqli_close($db_conx);
	header("location: ../../user_profile/index.php?u=$log_username");
	exit();
}
?><?php 
